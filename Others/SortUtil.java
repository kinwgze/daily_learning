...
public class SortUtils<T> implements Comparator<T>
{
    ...
    public static final Comparator<String> NUMERICAL_ORDER = new SortUtils<String>(false);
    public static final Comparator<String> CASEINSENSITIVE_NUMERICAL_ORDER = new SortUtils<String>(true);

    private final boolean caseInsensitive;

    public SortUtils(boolean caseInsensitive) {
